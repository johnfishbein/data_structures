...
/*@constructor MiddleEarth - creates a MiddleEarth world with a specified size and number of cities
 *@param xsize sets width of the world
 *@param ysize sets height of the world
 *@param seed determines whether to randomly generate a world or specifically generate the world
 *
 */
...
/*@method print 
 *prints all of the cities in the genereated MiddleEarth world and their positions
 *
 *
 */
...
/*@method print Table
 *prints all of the cities in the genereated MiddleEarth world and their positions in a format loadable to excel
 */
...
/*@method getDistance
 *calculates and returns the distance between two cities
...
/*@method getItinerary
 *puts together a list of cities to visit of a specified length
 *@param length number of cities to visit
 *@return vector of other cities to visit
 */
